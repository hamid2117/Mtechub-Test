...
export default function Login() {
  ...
  const {register,openLogin,closeRegister } = useGlobalContext()
        ...
        <Fade in={register}>
          <div className={classes.paper}>
            ...
            <form onSubmit={formik.handleSubmit} className={classes.inputs}>
              ...
              />
            <Button className={classes.sign} type="submit">Register</Button>              
            </form>
            <div style={{display:"grid",gridTemplateColumns:"2fr 1fr"}}>
              <h5 style={{marginTop:"10px"}}>Already have account ?</h5>
              <Button variant="outlined" color="primary" onClick={()=>openLogin()}>
                Login
              </Button>
            </div>
          </div>
